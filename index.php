        ...
        <header class="">
            ...
            <nav class="navbar navbar-expand-sm bg-light admin-nav-text shadow-sm m-0 p-0">
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-8 col-sm-6 d-flex justify-content-end">
                        ...
                        <a href="?page=signin" class="p-2 text-success col-none col-sm-none col-md-none"><i class="fas fa-sign-in-alt  text-dark mr-1"></i>SignIn</a>

                        <a href="?page=signup" class="p-2  text-primary rounded col-none col-sm-none col-md-none"><i class="fas fa-user-plus text-dark mr-1"></i>SignUp</a>

                        <button onclick="show('nav-modal')" id="tab-nav-btn" class="btn btn-md bg-light p-2 text-primary rounded"><i style="font-size: 22px" class="fas fa-bars text-dark"></i></button>
