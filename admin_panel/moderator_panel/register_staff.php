...
<div class="col-10">
    ...
    <div class="rg-lg-form mx-auto">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']),'?page=staff' ?>" class="bg-light shadow mt-5 p-2 rounded small" method="POST">
            ...
            <div class="form-group">
                <lable for="newStaffName">Name:
                    <a href="#" data-toggle="popover" data-placement="right" title="New name" data-content="Type the name you wish for your staff or subcontractor company. It could be something like "Staff", "Office" or company name such as "Companyname LTD"><i class="far fa-question-circle text-success"></i></a>
                </lable>
        ...
        <p class="text-justify small mt-2 p-2 border shadow">Use this form to add subcontractor or your staff to the project. After you create new project staff you could add your employees or subcontracors employees.  </p>
    </div>
</div>
<?php echo $jqueryBell; ?>
<script>
